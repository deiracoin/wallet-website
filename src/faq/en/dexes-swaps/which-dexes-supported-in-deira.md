# Which DEXes are supported in dEiRA?

dEiRA wallet currently supports the following decentralized exchanges:
...
In the future, dEiRA aims to complete integration with the [Thorchain](https://thorchain.org) decentralized exchange that enables cryptocurrency trades between blockchains.
