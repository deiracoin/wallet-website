...
To address this for Bitcoin and Bitcoin-based cryptocurrencies, wallets like dEiRA implement a privacy-preserving mechanism that enables Bitcoin wallets to work with an unlimited number of addresses.
